...
export function PublicMonthCalendar({ project }: { project: Project }) {
  ...
  return (
    <div className="rounded-md border">
      ...
      <div className="flex items-center justify-center gap-4 border-b bg-muted/20 py-1.5 text-xs text-muted-foreground">
        ...
        <div className="flex items-center gap-2">
          <Switch id="week-view" checked={weekView} onCheckedChange={setWeekView} />
          <Label htmlFor="week-view" className="text-xs font-normal text-muted-foreground">
            Week view
          </Label>
        </div>
      </div>
